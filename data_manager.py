...
class DataManager(object):
    def __init__(self):
        ...
        self.velocity_xs = input_x[:,1]
        self.velocity_zs = input_x[:,2]
        self.anglular_velocities = input_x[:,3]

        self.pos_xs = input_y[:,0]
        self.pos_zs = input_y[:,1]
        self.angles = input_x[:,0] * np.pi
